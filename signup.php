...
if(isset($_POST["submit"])){
	...
	$duplicate = mysqli_query($conn,"SELECT * FROM user_table WHERE username ='$username' OR email= '$email'");
    ...
    "<script> alert('Username or Email Has Already Taken'); </script>";
			...
			if($password == $conpassword){
				$query = "INSERT INTO user_table VALUES('','$name','$username','$email','$password')";
				mysqli_query($conn,$query);
				echo "<script>alert('Registerion Successful');</script>";
			}
			else
			{
        ...
        <div>
          ...
          <div class="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
            <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
              ...
              <!-- <a href="#" class="block w-full px-5 py-3 text-center font-medium text-indigo-600 bg-gray-50 hover:bg-gray-100"> Log out </a> -->
            </div>
          </div>
        </div>
          ...
          <div class="sm:text-center lg:text-left">
            ...
            <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
              <div class="rounded-md shadow">
                <label class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10 show-btn" id="show" onclick="openform()"> Sign Up </label>
                <!-- <label for="show" class="show-btn px-8 py-3">SIGN UP</label> -->
              </div>
              <div class="mt-3 sm:mt-0 sm:ml-3">
                <a href="login.php" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 md:py-4 md:text-lg md:px-10" onclick="openlogin()"> Log In </a>
              </div>
            </div>
          </div>
        </main>
