...
<body>
    ...
    <div class="get">
      ...
      <div class="relative bg-white overflow-hidden">
              ...
              <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
                <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                  ...
                  <div class=" mr-5 hidden md:block md:ml-10 md:pr-4 md:space-x-8" id="navbar">
                    ...
                    .
                    <a href="#map" class=" mr-5 navlinks">Stations</a>
              ...
              <div class="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                  ...
                  <div class="px-2 pt-2 pb-3 space-y-1">
                    ...
                    <a href="#map" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Stations</a>
                  </div>
                  <a href="logout.php" class="block w-full px-5 py-3 text-center font-medium text-indigo-600 bg-gray-50 hover:bg-gray-100"> Log out </a>
                </div>
              </div>
            </div>

            <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28" id="sec1">
              <div class="sm:text-center lg:text-left welcome-text">
                <!-- <div class="popup">
              <div class="center" id="login_form">
                  ...
                  <div class="text"><h2>Log In</h2></div>
                    <form action="#" class="" method="post" autocomplete="off">
                      <div class="data">
                        ...
                        <input type="text" name="useremail" id = "useremail" required value="" placeholder="Enter Your Username or Email">
                      </div>
                      <div class="data">
                ...
                <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start ">
                  ...
                  <!-- <div class="rounded-md shadow">
                    <a href="logout.php" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10 show-btn" id="show" > Log Out </a>
                </div> -->

                  <!-- <div class="mt-3 sm:mt-0 sm:ml-3">
                <a href="login.html" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 md:py-4 md:text-lg md:px-10" onclick="openlogin()"> Log In </a>
              </div> -->
                </div>
                <!-- <label for="welcome" class="show-btn text-4xl tracking-tight font-extrabold text-gray-900 sm:text-4xl md:text-5xl">Welcome&nbsp;<h2><span class="auto-type"><?php echo $row["name"]; ?></span></h2></label> -->

                <div class="show-btn text-4xl tracking-tight font-extrabold text-gray-900 sm:text-4xl md:text-5xl">
                  Welcome <h2><span class="auto-type"></span></h2>
                </div>
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          ...
          <!-- <div class="popup">
        <div class="center" id="my_form">
          <label for="show" class="close-btn" onclick="closeform()">&times;</label>
            <div class="text"><h2>Registration</h2></div>
              <form action="#" class="" method="post" autocomplete="off">
                <div class="data">
                ...
                <div class="data">
                  ...
                  <input type="password" name="conpassword" id="conpassword" placeholder="Re-Enter Your Password" required value="">
                </div>
                <div class="btn">
                  <div class="inner" id="btn"></div>
      ...
      <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6 ">
        <div class="p-4 md:w-1/3 flex">
          ...
          <div class="flex-grow pl-6" id="cards" data-aos="fade-right" data-aos-offset="500">
            ...
            <p class="leading-relaxed text-base">All electric cars come with a cable that connects to the vehicle’s on-board charger and a standard household 120v outlet. One end of the cord has a standard 3-prong household plug. On the other end is a J1772 connector, which plugs into the vehicle.</p>
            <p> Level 1 charging is the least expensive and most convenient charging option, and 120v outlets are readily available.</p>
        ...
        <div class="p-4 md:w-1/3 flex ">
          ...
          <div class="flex-grow pl-6" id="cards" data-aos="fade-left" data-aos-offset="500">
            ...
            <p class="leading-relaxed text-base">DC Fast Charging (DCFC) is available at rest stops, shopping malls, and office buildings. DCFC is ultra-rapid charging with rates of 125 miles of added range in about 30 minutes or 250 miles in about an hour.</p>
            <p> Many vehicles are capable of getting an 80% charge in about or under an hour using most currently available DC fast chargers.</p>
  ...
  <section class="text-gray-600 body-font relative">
    <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
      ...
      <form action="https://formspree.io/f/xrgjwgey" method="post" autocomplete="off" class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0" id="map" data-aos="fade-left">
...
<script >
  function sendEmail(){
    ...
    Username : "ElectrifyIndia01@gmail.com",
    Password : "**********8CD7F",
    To : 'ElectrifyIndia01@gmail.com',
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      var typed = new Typed('.auto-type', {
        strings: ['<?php echo trim(htmlspecialchars($row["name"])); ?>'],
        typeSpeed: 70,
        backSpeed: 70,
        loop: true
      });
